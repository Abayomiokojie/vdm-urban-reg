...
const Hero = () => {
  return (
    <>
      <section
        className=" pb-36 pt-16 bg-blue-50 -z-50 px-4 sm:px-8 md:px-10 "
        id="home"
      >
        <div className="container mx-auto relative max-w-[1240px]">
          <div className="w-full grid justify-center md:justify-between md:flex  gap-16 items-center">
            <div className="max-w-[500px] mx-auto md:mx-0 flex-1 text-center md:text-left">
              <h1 className="text-5xl sm:text-5xl font-bold mb-4 leading-tight text-[#040455] ">
            ...
            <div className="relative bg-transparent text-black z-0 max-w-[500px] flex-1 mx-auto mr-10 ml-10 ">
              {/* <div className="relative z-0 mr-10 lg:mr-0"> */}
              <Image
                src={HeroImage}
              ...
              <div className="absolute -left-2 top-3 sm:top-10 z-51 px-3 py-2 shadow-xl bg-green-100 outline-5 outline-slate-50 rounded-2xl hover:scale-105 transition-all duration-300 scale-75 min-[450px]:scale-100">
                Build <span className="font-bold">Safely</span>
              </div>
              <div className="absolute -right-5 sm:-right-10 top-40 z-50 px-3 py-2 shadow-xl rounded-2xl outline-5 outline-slate-50 bg-slate-100 hover:scale-105 transition-all duration-300 scale-75 min-[450px]:scale-100">
                Build <span className="font-bold">Legally</span>
              </div>
              <div className="absolute -left-5 bottom-5 sm:bottom-10 z-50 px-3 py-2 shadow-xl rounded-2xl outline-5 outline-slate-50 bg-blue-100 hover:scale-105 transition-all duration-300 scale-75 min-[450px]:scale-100">
